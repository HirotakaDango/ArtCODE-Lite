...
<html lang="en">
  ...
  <body>
    <br>
    <div class="container">
      <div id="login-form" class="animate__animated animate__fadeInUp animate__1s">
        <br>
      ...
      <div id="register-form" class="animate__animated animate__fadeInDown animate__1s" style="display:none;">
        <br>
        <center><h1><i class="bi bi-person-circle"></i></h1></center>
